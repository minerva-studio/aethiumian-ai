...
namespace Amlos.AI.Editor
{
    ...
    {
        private AdvancedDropdownState functionPickerState;
            ...
            using (EditorGUIIndent.Increase)
            {
                ...
                using (new GUILayout.HorizontalScope())
                {
                    ...
                    if (GUI.Button(selectRect, "Select..."))
                    {
                        ...
                        FunctionPickerDropdown dropdown = new(functionPickerState, BuildCandidates(function), selected =>
                        {
        ...
        private IEnumerable<FunctionRegistry.FunctionCandidate> BuildCandidates(FunctionReference function)
        {
            foreach (FunctionRegistry.FunctionCandidate candidate in FunctionRegistry.GetCustomFunctions())
            {
                yield return candidate;
            }

            foreach (FunctionRegistry.FunctionCandidate candidate in FunctionRegistry.GetArithmeticFunctions())
            {
                yield return candidate;
            }
