...
{
    /// <summary>Defines package-local Physics2D layers for isolated navigation fixtures.</summary>
    internal static class NavigationPhysicsTestLayers
    {
        ...
        /// <summary>Creates the execution filter shared by package-owned terrain fixtures.</summary>
        internal static ContactFilter2D CreateTerrainFilter()
            => new NavigationPhysicsLayers(GeometryMask, PlatformMask).CreateTerrainFilter();
    }
}
